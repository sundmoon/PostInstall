# Run this in an administrative PowerShell prompt to install the PostInstall PowerShell module:
#
# 	iex (New-Object Net.WebClient).DownloadString("https://github.com/sundmoon/PostInstall/raw/master/Install.ps1")

# Some general variables
$ModuleName = 'PostInstall'
$DownloadURL = 'https://github.com/sundmoon/PostInstall/raw/master/release/PostInstall-current.zip'
